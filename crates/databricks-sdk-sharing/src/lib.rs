...
//! (`databricks_sdk::service::sharing`).
...
pub struct DeltaSharingFunction {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub tags: Vec<::databricks_sdk_catalog::TagKeyValue>,
}
...
impl DeltaSharingFunction {
    ...
    pub fn with_tags(
        mut self,
        value: impl Into<Vec<::databricks_sdk_catalog::TagKeyValue>>,
    ) -> Self {
...
impl ProvidersApi {
    ...
    pub async fn create(&self, request: CreateProvider) -> ::databricks_core::Result<ProviderInfo> {
    ...
    ) -> ::databricks_core::Result<ProviderInfo> {
        let path = format!(
            "/api/2.1/unity-catalog/providers/{}",
            path_param(&request.name.to_string(), false)
        );
    ...
    ) -> ::databricks_core::Result<ListProviderShareAssetsResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ListProviderSharesResponse> {
        let path = format!(
    ...
    pub async fn list_shares_all(
        &self,
        request: ListSharesRequest,
    ) -> ::databricks_core::Result<Vec<ProviderShare>> {
    ...
    pub async fn update(&self, request: UpdateProvider) -> ::databricks_core::Result<ProviderInfo> {
        let path = format!(
            "/api/2.1/unity-catalog/providers/{}",
            path_param(&request.name.to_string(), false)
        );
...
impl RecipientActivationApi {
    ...
    ) -> ::databricks_core::Result<RetrieveTokenResponse> {
        let path = format!(
...
impl RecipientFederationPoliciesApi {
    ...
    ) -> ::databricks_core::Result<FederationPolicy> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ListFederationPoliciesResponse> {
        let path = format!(
            "/api/2.0/data-sharing/recipients/{}/federation-policies",
            path_param(&request.recipient_name.to_string(), false)
        );
    ...
    pub async fn list_all(
        &self,
        request: ListFederationPoliciesRequest,
    ) -> ::databricks_core::Result<Vec<FederationPolicy>> {
        paging::collect(self.list(request)).await
    }
}
...
impl RecipientsApi {
    ...
    ) -> ::databricks_core::Result<RecipientInfo> {
    ...
    pub async fn delete(&self, request: DeleteRecipientRequest) -> ::databricks_core::Result<()> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ListRecipientsResponse> {
        let path = String::from("/api/2.1/unity-catalog/recipients");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field(
    ...
    pub async fn list_all(
        &self,
        request: ListRecipientsRequest,
    ) -> ::databricks_core::Result<Vec<RecipientInfo>> {
        paging::collect(self.list(request)).await
    }
    ...
    ) -> ::databricks_core::Result<GetRecipientSharePermissionsResponse> {
        let path = format!(
...
impl SharesApi {
    ...
    pub async fn create(&self, request: CreateShare) -> ::databricks_core::Result<ShareInfo> {
    ...
    pub async fn delete(&self, request: DeleteShareRequest) -> ::databricks_core::Result<()> {
        let path = format!(
    ...
    pub async fn get(&self, request: GetShareRequest) -> ::databricks_core::Result<ShareInfo> {
        let path = format!(
            "/api/2.1/unity-catalog/shares/{}",
            path_param(&request.name.to_string(), false)
        );
    ...
    ) -> ::databricks_core::Result<ListSharesResponse> {
        let path = String::from("/api/2.1/unity-catalog/shares");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("max_results", &request.max_results)?);
        call = call.query(query::field("page_token", &request.page_token)?);
    ...
    pub async fn list_shares_all(
        &self,
        request: SharesListRequest,
    ) -> ::databricks_core::Result<Vec<ShareInfo>> {
        paging::collect(self.list_shares(request)).await
    }
    ...
    pub async fn share_permissions(
        &self,
        request: SharePermissionsRequest,
    ) -> ::databricks_core::Result<GetSharePermissionsResponse> {
        let path = format!(
    ...
    pub async fn update(&self, request: UpdateShare) -> ::databricks_core::Result<ShareInfo> {
        let path = format!(
            "/api/2.1/unity-catalog/shares/{}",
            path_param(&request.name.to_string(), false)
        );
    ...
    ) -> ::databricks_core::Result<UpdateSharePermissionsResponse> {
        let path = format!(
            "/api/2.1/unity-catalog/shares/{}/permissions",
            path_param(&request.name.to_string(), false)
        );
