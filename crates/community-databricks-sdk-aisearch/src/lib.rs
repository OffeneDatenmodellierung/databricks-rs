...
//! (`community_databricks_sdk::service::aisearch`).
...
impl AiSearchApi {
    ...
    ) -> ::community_databricks_core::Result<Index> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<ListIndexesResponse> {
        let path = format!(
            "/api/2.0/ai-search/{}/indexes",
            path_param(&request.parent.to_string(), true)
        );
    ...
    pub async fn list_indexes_all(
        &self,
        request: ListIndexesRequest,
    ) -> ::community_databricks_core::Result<Vec<Index>> {
    ...
    ) -> ::community_databricks_core::Result<QueryIndexResponse> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<RemoveDataResponse> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<ScanIndexResponse> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<SyncIndexResponse> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<UpsertDataResponse> {
        let path = format!(
