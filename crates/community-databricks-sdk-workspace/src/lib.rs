...
//! (`community_databricks_sdk::service::workspace`).
...
impl GitCredentialsApi {
    ...
    ) -> ::community_databricks_core::Result<CreateCredentialsResponse> {
    ...
    ) -> ::community_databricks_core::Result<GetCredentialsResponse> {
        let path = format!(
            "/api/2.0/git-credentials/{}",
            path_param(&request.credential_id.to_string(), false)
        );
    ...
    ) -> ::community_databricks_core::Result<ListCredentialsResponse> {
        let path = String::from("/api/2.0/git-credentials");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("principal_id", &request.principal_id)?);
        call = call.query(query::to_pairs(&request.other)?);
    ...
    pub async fn list_all(
        &self,
        request: ListCredentialsRequest,
    ) -> ::community_databricks_core::Result<Vec<CredentialInfo>> {
...
impl ReposApi {
    ...
    ) -> ::community_databricks_core::Result<CreateRepoResponse> {
    ...
    ) -> ::community_databricks_core::Result<GetRepoResponse> {
        let path = format!(
            "/api/2.0/repos/{}",
            path_param(&request.repo_id.to_string(), false)
        );
    ...
    ) -> ::community_databricks_core::Result<GetRepoPermissionLevelsResponse> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<RepoPermissions> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<ListReposResponse> {
        let path = String::from("/api/2.0/repos");
        let mut call = Call::new(Method::GET, path).workspace();
    ...
    pub async fn list_all(
        &self,
        request: ListReposRequest,
    ) -> ::community_databricks_core::Result<Vec<RepoInfo>> {
        paging::collect(self.list(request)).await
    }
...
impl SecretsApi {
    ...
    pub async fn delete_acl(&self, request: DeleteAcl) -> ::community_databricks_core::Result<()> {
    ...
    ) -> ::community_databricks_core::Result<AclItem> {
    ...
    ) -> ::community_databricks_core::Result<GetSecretResponse> {
    ...
    ) -> ::community_databricks_core::Result<ListAclsResponse> {
    ...
    pub async fn list_acls_all(
        &self,
        request: ListAclsRequest,
    ) -> ::community_databricks_core::Result<Vec<AclItem>> {
    ...
    pub async fn list_scopes_page(
        &self,
    ) -> ::community_databricks_core::Result<ListScopesResponse> {
    ...
    pub async fn list_scopes_all(&self) -> ::community_databricks_core::Result<Vec<SecretScope>> {
    ...
    ) -> ::community_databricks_core::Result<ListSecretsResponse> {
    ...
    pub async fn list_secrets_all(
        &self,
        request: ListSecretsRequest,
    ) -> ::community_databricks_core::Result<Vec<SecretMetadata>> {
    ...
    pub async fn put_acl(&self, request: PutAcl) -> ::community_databricks_core::Result<()> {
    ...
    pub async fn put_secret(&self, request: PutSecret) -> ::community_databricks_core::Result<()> {
...
impl WorkspaceApi {
    ...
    pub async fn delete(&self, request: Delete) -> ::community_databricks_core::Result<()> {
    ...
    ) -> ::community_databricks_core::Result<ExportResponse> {
    ...
    ) -> ::community_databricks_core::Result<GetWorkspaceObjectPermissionLevelsResponse> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<WorkspaceObjectPermissions> {
        let path = format!(
            "/api/2.0/permissions/{}/{}",
            path_param(&request.workspace_object_type.to_string(), false),
            path_param(&request.workspace_object_id.to_string(), false)
    ...
    ) -> ::community_databricks_core::Result<ObjectInfo> {
    ...
    pub async fn import(&self, request: Import) -> ::community_databricks_core::Result<()> {
    ...
    pub async fn list_all(
        &self,
        request: ListWorkspaceRequest,
    ) -> ::community_databricks_core::Result<Vec<ObjectInfo>> {
        paging::collect(self.list(request)).await
    }
    ...
    pub async fn mkdirs(&self, request: Mkdirs) -> ::community_databricks_core::Result<()> {
