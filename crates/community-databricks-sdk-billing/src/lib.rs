...
//! (`community_databricks_sdk::service::billing`).
...
pub struct BudgetPolicy {
    ...
    /// per policy.
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub custom_tags: Vec<::community_databricks_sdk_compute::CustomPolicyTag>,
...
impl BudgetPolicy {
    ...
    pub fn with_custom_tags(
        mut self,
        value: impl Into<Vec<::community_databricks_sdk_compute::CustomPolicyTag>>,
    ) -> Self {
...
impl BudgetPolicyApi {
    ...
    ) -> ::community_databricks_core::Result<ListBudgetPoliciesResponse> {
        let path = format!(
            "/api/2.1/accounts/{}/budget-policies",
            path_param(self.api.account_id()?, false)
        );
    ...
    pub async fn list_all(
        &self,
        request: ListBudgetPoliciesRequest,
    ) -> ::community_databricks_core::Result<Vec<BudgetPolicy>> {
...
impl BudgetsApi {
    ...
    ) -> ::community_databricks_core::Result<CreateBudgetConfigurationResponse> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<GetBudgetConfigurationResponse> {
        let path = format!(
            "/api/2.1/accounts/{}/budgets/{}",
            path_param(self.api.account_id()?, false),
            path_param(&request.budget_id.to_string(), false)
    ...
    ) -> ::community_databricks_core::Result<ListBudgetConfigurationsResponse> {
        let path = format!(
            "/api/2.1/accounts/{}/budgets",
            path_param(self.api.account_id()?, false)
        );
    ...
    pub async fn list_all(
        &self,
        request: ListBudgetConfigurationsRequest,
    ) -> ::community_databricks_core::Result<Vec<BudgetConfiguration>> {
        paging::collect(self.list(request)).await
    }
    ...
    ) -> ::community_databricks_core::Result<UpdateBudgetConfigurationResponse> {
        let path = format!(
            "/api/2.1/accounts/{}/budgets/{}",
            path_param(self.api.account_id()?, false),
            path_param(&request.budget_id.to_string(), false)
...
impl LogDeliveryApi {
    ...
    ) -> ::community_databricks_core::Result<WrappedLogDeliveryConfiguration> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<GetLogDeliveryConfigurationResponse> {
        let path = format!(
            "/api/2.0/accounts/{}/log-delivery/{}",
            path_param(self.api.account_id()?, false),
    ...
    ) -> ::community_databricks_core::Result<WrappedLogDeliveryConfigurations> {
        let path = format!(
            "/api/2.0/accounts/{}/log-delivery",
            path_param(self.api.account_id()?, false)
        );
    ...
    pub async fn list_all(
        &self,
        request: ListLogDeliveryRequest,
    ) -> ::community_databricks_core::Result<Vec<LogDeliveryConfiguration>> {
        paging::collect(self.list(request)).await
    }
...
impl UsageDashboardsApi {
    ...
    ) -> ::community_databricks_core::Result<CreateBillingUsageDashboardResponse> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<GetBillingUsageDashboardResponse> {
        let path = format!(
            "/api/2.0/accounts/{}/dashboard",
            path_param(self.api.account_id()?, false)
        );
