...
//! (`community_databricks_sdk::service::disasterrecovery`).
...
impl DisasterRecoveryApi {
    ...
    ) -> ::community_databricks_core::Result<FailoverGroup> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<StableUrl> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<ListFailoverGroupsResponse> {
        let path = format!(
            "/api/disaster-recovery/v1/{}/failover-groups",
            path_param(&request.parent.to_string(), true)
        );
    ...
    pub async fn list_failover_groups_all(
        &self,
        request: ListFailoverGroupsRequest,
    ) -> ::community_databricks_core::Result<Vec<FailoverGroup>> {
    ...
    ) -> ::community_databricks_core::Result<ListStableUrlsResponse> {
        let path = format!(
            "/api/disaster-recovery/v1/{}/stable-urls",
            path_param(&request.parent.to_string(), true)
        );
    ...
    pub async fn list_stable_urls_all(
        &self,
        request: ListStableUrlsRequest,
    ) -> ::community_databricks_core::Result<Vec<StableUrl>> {
