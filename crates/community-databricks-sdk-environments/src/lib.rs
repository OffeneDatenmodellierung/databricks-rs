...
//! (`community_databricks_sdk::service::environments`).
...
impl EnvironmentsApi {
    ...
    ) -> ::community_databricks_core::Result<DefaultWorkspaceBaseEnvironment> {
        let path = format!(
            "/api/environments/v1/{}",
            path_param(&request.name.to_string(), true)
        );
    ...
    ) -> ::community_databricks_core::Result<WorkspaceBaseEnvironment> {
        let path = format!(
            "/api/environments/v1/{}",
            path_param(&request.name.to_string(), true)
        );
    ...
    ) -> ::community_databricks_core::Result<ListWorkspaceBaseEnvironmentsResponse> {
        let path = String::from("/api/environments/v1/workspace-base-environments");
        let mut call = Call::new(Method::GET, path).workspace();
    ...
    pub async fn list_workspace_base_environments_all(
        &self,
        request: ListWorkspaceBaseEnvironmentsRequest,
    ) -> ::community_databricks_core::Result<Vec<WorkspaceBaseEnvironment>> {
