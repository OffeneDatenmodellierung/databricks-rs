...
//! (`databricks_sdk::service::aifunctions`).
...
impl AiFunctionsApi {
    ...
    ) -> ::databricks_core::Result<AiClassifyResponse> {
    ...
    ) -> ::databricks_core::Result<AiExtractResponse> {
    ...
    ) -> ::databricks_core::Result<AiParseDocumentResponse> {
