...
impl AccessControlApi {
    ...
    ) -> ::databricks_core::Result<CheckPolicyResponse> {
...
impl AccountAccessControlProxyApi {
    ...
    ) -> ::databricks_core::Result<GetAssignableRolesForResourceResponse> {
    ...
    ) -> ::databricks_core::Result<RuleSetResponse> {
...
impl CurrentUserApi {
    ...
    pub async fn me(&self, request: MeRequest) -> ::databricks_core::Result<User> {
...
impl GroupsV2Api {
    ...
    pub async fn create(&self, request: CreateGroupRequest) -> ::databricks_core::Result<Group> {
    ...
    pub async fn delete(&self, request: DeleteGroupRequest) -> ::databricks_core::Result<()> {
        let path = format!(
    ...
    pub async fn get(&self, request: GetGroupRequest) -> ::databricks_core::Result<Group> {
        let path = format!(
            "/api/2.0/preview/scim/v2/Groups/{}",
            path_param(&request.id.to_string(), false)
        );
    ...
    pub async fn patch(&self, request: PatchGroupRequest) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/preview/scim/v2/Groups/{}",
            path_param(&request.id.to_string(), false)
        );
    ...
    pub async fn update(&self, request: UpdateGroupRequest) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/preview/scim/v2/Groups/{}",
            path_param(&request.id.to_string(), false)
        );
...
impl PermissionMigrationApi {
    ...
    ) -> ::databricks_core::Result<MigratePermissionsResponse> {
...
impl PermissionsApi {
    ...
    ) -> ::databricks_core::Result<ObjectPermissions> {
        let path = format!(
            "/api/2.0/permissions/{}/{}",
    ...
    ) -> ::databricks_core::Result<GetPermissionLevelsResponse> {
        let path = format!(
...
impl ServicePrincipalsV2Api {
    ...
    ) -> ::databricks_core::Result<ListServicePrincipalResponse> {
        let path = String::from("/api/2.0/preview/scim/v2/ServicePrincipals");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("attributes", &request.attributes)?);
        call = call.query(query::field("count", &request.count)?);
...
impl UsersV2Api {
    ...
    pub async fn create(&self, request: CreateUserRequest) -> ::databricks_core::Result<User> {
    ...
    pub async fn delete(&self, request: DeleteUserRequest) -> ::databricks_core::Result<()> {
        let path = format!(
    ...
    pub async fn get(&self, request: GetUserRequest) -> ::databricks_core::Result<User> {
        let path = format!(
            "/api/2.0/preview/scim/v2/Users/{}",
            path_param(&request.id.to_string(), false)
        );
    ...
    ) -> ::databricks_core::Result<GetPasswordPermissionLevelsResponse> {
        let _ = request;
    ...
    ) -> ::databricks_core::Result<PasswordPermissions> {
        let _ = request;
    ...
    pub async fn patch(&self, request: PatchUserRequest) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/preview/scim/v2/Users/{}",
            path_param(&request.id.to_string(), false)
        );
    ...
    pub async fn update(&self, request: UpdateUserRequest) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/preview/scim/v2/Users/{}",
            path_param(&request.id.to_string(), false)
        );
...
impl AccountGroupsV2Api {
    ...
    ) -> ::databricks_core::Result<AccountGroup> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ListAccountGroupsResponse> {
        let path = format!(
            "/api/2.0/accounts/{}/scim/v2/Groups",
            path_param(self.api.account_id()?, false)
        );
    ...
    pub async fn list_all(
        &self,
        request: ListAccountGroupsRequest,
    ) -> ::databricks_core::Result<Vec<AccountGroup>> {
        paging::collect(self.list(request)).await
    }
    ...
    pub async fn patch(&self, request: PatchAccountGroupRequest) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/accounts/{}/scim/v2/Groups/{}",
            path_param(self.api.account_id()?, false),
            path_param(&request.id.to_string(), false)
...
impl AccountServicePrincipalsV2Api {
    ...
    ) -> ::databricks_core::Result<AccountServicePrincipal> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ListAccountServicePrincipalsResponse> {
        let path = format!(
            "/api/2.0/accounts/{}/scim/v2/ServicePrincipals",
            path_param(self.api.account_id()?, false)
        );
    ...
    pub async fn list_all(
        &self,
        request: ListAccountServicePrincipalsRequest,
    ) -> ::databricks_core::Result<Vec<AccountServicePrincipal>> {
        paging::collect(self.list(request)).await
    }
...
impl AccountUsersV2Api {
    ...
    ) -> ::databricks_core::Result<AccountUser> {
        let path = format!(
    ...
    pub async fn delete(&self, request: DeleteAccountUserRequest) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/accounts/{}/scim/v2/Users/{}",
            path_param(self.api.account_id()?, false),
            path_param(&request.id.to_string(), false)
    ...
    ) -> ::databricks_core::Result<ListAccountUsersResponse> {
        let path = format!(
            "/api/2.0/accounts/{}/scim/v2/Users",
            path_param(self.api.account_id()?, false)
        );
    ...
    pub async fn list_all(
        &self,
        request: ListAccountUsersRequest,
    ) -> ::databricks_core::Result<Vec<AccountUser>> {
        paging::collect(self.list(request)).await
    }
    ...
    pub async fn patch(&self, request: PatchAccountUserRequest) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/accounts/{}/scim/v2/Users/{}",
            path_param(self.api.account_id()?, false),
            path_param(&request.id.to_string(), false)
    ...
    pub async fn update(&self, request: UpdateAccountUserRequest) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/accounts/{}/scim/v2/Users/{}",
            path_param(self.api.account_id()?, false),
            path_param(&request.id.to_string(), false)
...
impl WorkspaceAssignmentApi {
    ...
    ) -> ::databricks_core::Result<WorkspacePermissions> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<PermissionAssignments> {
        let path = format!(
    ...
    pub async fn list_all(
        &self,
        request: ListWorkspaceAssignmentRequest,
    ) -> ::databricks_core::Result<Vec<PermissionAssignment>> {
        paging::collect(self.list(request)).await
    }
    ...
    ) -> ::databricks_core::Result<PermissionAssignment> {
        let path = format!(
            "/api/2.0/accounts/{}/workspaces/{}/permissionassignments/principals/{}",
            path_param(self.api.account_id()?, false),
            path_param(&request.workspace_id.to_string(), false),
