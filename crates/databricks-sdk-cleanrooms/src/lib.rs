...
//! (`databricks_sdk::service::cleanrooms`).
...
pub struct CleanRoomAssetForeignTable {
    ...
    pub columns: Vec<::databricks_sdk_catalog::ColumnInfo>,
}
...
impl CleanRoomAssetForeignTable {
    ...
    pub fn with_columns(
        mut self,
        value: impl Into<Vec<::databricks_sdk_catalog::ColumnInfo>>,
    ) -> Self {
...
pub struct CleanRoomAssetTableLocalDetails {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub partitions: Vec<::databricks_sdk_sharing::Partition>,
}
...
impl CleanRoomAssetTableLocalDetails {
    ...
    pub fn with_partitions(
        mut self,
        value: impl Into<Vec<::databricks_sdk_sharing::Partition>>,
    ) -> Self {
...
pub struct CleanRoomNotebookTaskRun {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub notebook_job_run_state: Option<::databricks_sdk_jobs::CleanRoomTaskRunState>,
...
impl CleanRoomNotebookTaskRun {
    ...
    pub fn with_notebook_job_run_state(
        mut self,
        value: impl Into<::databricks_sdk_jobs::CleanRoomTaskRunState>,
    ) -> Self {
...
pub struct CleanRoomRemoteDetail {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub egress_network_policy: Option<::databricks_sdk_settings::EgressNetworkPolicy>,
...
impl CleanRoomRemoteDetail {
    ...
    pub fn with_egress_network_policy(
        mut self,
        value: impl Into<::databricks_sdk_settings::EgressNetworkPolicy>,
    ) -> Self {
...
pub struct CleanRoomTaskRun {
    ...
    /// State of the task run.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub task_run_state: Option<::databricks_sdk_jobs::CleanRoomTaskRunState>,
...
pub struct ComplianceSecurityProfile {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub compliance_standards: Vec<::databricks_sdk_settings::ComplianceStandard>,
...
impl ComplianceSecurityProfile {
    ...
    pub fn with_compliance_standards(
        mut self,
        value: impl Into<Vec<::databricks_sdk_settings::ComplianceStandard>>,
    ) -> Self {
...
impl CleanRoomAssetRevisionsApi {
    ...
    ) -> ::databricks_core::Result<CleanRoomAsset> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ListCleanRoomAssetRevisionsResponse> {
        let path = format!(
            "/api/2.0/clean-rooms/{}/assets/{}/{}/revisions",
            path_param(&request.clean_room_name.to_string(), false),
            path_param(&request.asset_type.to_string(), false),
    ...
    pub async fn list_all(
        &self,
        request: ListCleanRoomAssetRevisionsRequest,
    ) -> ::databricks_core::Result<Vec<CleanRoomAsset>> {
...
impl CleanRoomAssetsApi {
    ...
    ) -> ::databricks_core::Result<CreateCleanRoomAssetReviewResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ListCleanRoomAssetsResponse> {
        let path = format!(
            "/api/2.0/clean-rooms/{}/assets",
            path_param(&request.clean_room_name.to_string(), false)
        );
...
impl CleanRoomAutoApprovalRulesApi {
    ...
    ) -> ::databricks_core::Result<CleanRoomAutoApprovalRule> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ListCleanRoomAutoApprovalRulesResponse> {
        let path = format!(
            "/api/2.0/clean-rooms/{}/auto-approval-rules",
            path_param(&request.clean_room_name.to_string(), false)
        );
    ...
    pub async fn list_all(
        &self,
        request: ListCleanRoomAutoApprovalRulesRequest,
    ) -> ::databricks_core::Result<Vec<CleanRoomAutoApprovalRule>> {
        paging::collect(self.list(request)).await
    }
...
impl CleanRoomTaskRunsApi {
    ...
    ) -> ::databricks_core::Result<ListCleanRoomNotebookTaskRunsResponse> {
        let path = format!(
    ...
    pub async fn list_all(
        &self,
        request: ListCleanRoomNotebookTaskRunsRequest,
    ) -> ::databricks_core::Result<Vec<CleanRoomNotebookTaskRun>> {
        paging::collect(self.list(request)).await
    }
    ...
    ) -> ::databricks_core::Result<ListCleanRoomTaskRunsResponse> {
        let path = format!(
    ...
    pub async fn list_clean_room_task_runs_handler_all(
        &self,
        request: ListCleanRoomTaskRunsRequest,
    ) -> ::databricks_core::Result<Vec<CleanRoomTaskRun>> {
...
impl CleanRoomsApi {
    ...
    ) -> ::databricks_core::Result<WaitGetCleanRoomActive<CleanRoom>> {
    ...
    ) -> ::databricks_core::Result<CreateCleanRoomOutputCatalogResponse> {
        let path = format!(
    ...
    pub async fn delete(&self, request: DeleteCleanRoomRequest) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/clean-rooms/{}",
            path_param(&request.name.to_string(), false)
        );
    ...
    pub async fn get(&self, request: GetCleanRoomRequest) -> ::databricks_core::Result<CleanRoom> {
        let path = format!(
            "/api/2.0/clean-rooms/{}",
            path_param(&request.name.to_string(), false)
        );
    ...
    ) -> ::databricks_core::Result<ListCleanRoomsResponse> {
        let path = String::from("/api/2.0/clean-rooms");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("page_size", &request.page_size)?);
        call = call.query(query::field("page_token", &request.page_token)?);
    ...
    pub async fn list_all(
        &self,
        request: ListCleanRoomsRequest,
    ) -> ::databricks_core::Result<Vec<CleanRoom>> {
        paging::collect(self.list(request)).await
    }
    ...
    ) -> ::databricks_core::Result<CleanRoom> {
        let path = format!(
            "/api/2.0/clean-rooms/{}",
            path_param(&request.name.to_string(), false)
        );
...
impl<R> WaitGetCleanRoomActive<R> {
    ...
    pub async fn wait(self) -> ::databricks_core::Result<CleanRoom> {
        self.api
