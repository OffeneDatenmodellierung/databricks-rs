...
use databricks_core::auth::{DefaultCredentials, OAuthEndpoints};
use databricks_core::config::HostMetadata;
use databricks_core::{ApiClient, Config, Error, ErrorKind};
use reqwest::Method;
...
mod custom_chain {
    ...
    async fn pat_requires_a_host() {
        ...
        c.host_metadata = Some(databricks_core::config::HostMetadata::default());
