...
//! (`community_databricks_sdk::service::knowledgeassistants`).
...
impl KnowledgeAssistantsApi {
    ...
    ) -> ::community_databricks_core::Result<GetKnowledgeAssistantPermissionLevelsResponse> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<KnowledgeAssistantPermissions> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<ListKnowledgeAssistantsResponse> {
        let path = String::from("/api/2.1/knowledge-assistants");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("page_size", &request.page_size)?);
        call = call.query(query::field("page_token", &request.page_token)?);
    ...
    pub async fn list_knowledge_assistants_all(
        &self,
        request: ListKnowledgeAssistantsRequest,
    ) -> ::community_databricks_core::Result<Vec<KnowledgeAssistant>> {
    ...
    ) -> ::community_databricks_core::Result<ListKnowledgeSourcesResponse> {
        let path = format!(
            "/api/2.1/{}/knowledge-sources",
            path_param(&request.parent.to_string(), true)
        );
    ...
    pub async fn list_knowledge_sources_all(
        &self,
        request: ListKnowledgeSourcesRequest,
    ) -> ::community_databricks_core::Result<Vec<KnowledgeSource>> {
