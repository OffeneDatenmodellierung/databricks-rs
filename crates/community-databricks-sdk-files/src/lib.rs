...
//! (`community_databricks_sdk::service::files`).
...
impl DbfsApi {
    ...
    pub async fn add_block(&self, request: AddBlock) -> ::community_databricks_core::Result<()> {
    ...
    pub async fn close(&self, request: Close) -> ::community_databricks_core::Result<()> {
    ...
    ) -> ::community_databricks_core::Result<ListStatusResponse> {
    ...
    pub async fn move_(&self, request: Move) -> ::community_databricks_core::Result<()> {
    ...
    pub async fn put(&self, request: Put) -> ::community_databricks_core::Result<()> {
    ...
    pub async fn read(
        &self,
        request: ReadDbfsRequest,
    ) -> ::community_databricks_core::Result<ReadResponse> {
...
impl FilesApi {
    ...
    pub async fn get_directory_metadata(
        ...
        let mut call = Call::new(Method::HEAD, path).workspace();
        call = call.query(query::to_pairs(&request.other)?);
        self.api
            .send::<::serde::de::IgnoredAny>(call)
            .await
    ...
    ) -> ::community_databricks_core::Result<GetMetadataResponse> {
        let path = format!(
            "/api/2.0/fs/files{}",
            path_param(&request.file_path.to_string(), true)
        );
    ...
    ) -> ::community_databricks_core::Result<ListDirectoryResponse> {
        let path = format!(
            "/api/2.0/fs/directories{}",
            path_param(&request.directory_path.to_string(), true)
        );
