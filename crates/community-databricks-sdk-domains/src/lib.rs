...
//! (`community_databricks_sdk::service::domains`).
...
impl DomainsApi {
    ...
    ) -> ::community_databricks_core::Result<Domain> {
    ...
    ) -> ::community_databricks_core::Result<ListDomainsResponse> {
        let path = String::from("/api/2.0/domains");
    ...
    pub async fn list_domains_all(
        &self,
        request: ListDomainsRequest,
    ) -> ::community_databricks_core::Result<Vec<Domain>> {
