...
//! (`databricks_sdk::service::dataquality`).
...
impl DataQualityApi {
    ...
    ) -> ::databricks_core::Result<CancelRefreshResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<Monitor> {
    ...
    ) -> ::databricks_core::Result<Refresh> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ListMonitorResponse> {
        let path = String::from("/api/data-quality/v1/monitors");
    ...
    pub async fn list_monitor_all(
        &self,
        request: ListMonitorRequest,
    ) -> ::databricks_core::Result<Vec<Monitor>> {
    ...
    ) -> ::databricks_core::Result<ListRefreshResponse> {
        let path = format!(
            "/api/data-quality/v1/monitors/{}/{}/refreshes",
            path_param(&request.object_type.to_string(), false),
            path_param(&request.object_id.to_string(), false)
    ...
    pub async fn list_refresh_all(
        &self,
        request: ListRefreshRequest,
    ) -> ::databricks_core::Result<Vec<Refresh>> {
