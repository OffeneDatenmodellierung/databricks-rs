...
//! (`community_databricks_sdk::service::iamv2`).
...
impl WorkspaceIamV2Api {
    ...
    ) -> ::community_databricks_core::Result<DirectGroupMember> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<WorkspaceAssignmentDetail> {
    ...
    ) -> ::community_databricks_core::Result<WorkspaceAssignment> {
    ...
    ) -> ::community_databricks_core::Result<ExternalGroup> {
        let path = format!(
            "/api/2.0/identity/{}",
    ...
    ) -> ::community_databricks_core::Result<ExternalServicePrincipal> {
        let path = format!(
            "/api/2.0/identity/{}",
            path_param(&request.name.to_string(), true)
        );
    ...
    ) -> ::community_databricks_core::Result<ExternalUser> {
        let path = format!(
            "/api/2.0/identity/{}",
            path_param(&request.name.to_string(), true)
        );
    ...
    ) -> ::community_databricks_core::Result<WorkspaceAccessDetail> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<WorkspaceIdentityDetail> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<ListDirectGroupMembersResponse> {
        let path = format!(
            "/api/2.0/identity/groups/{}/direct-members",
            path_param(&request.group_id.to_string(), false)
        );
    ...
    pub async fn list_direct_group_members_proxy_all(
        &self,
        request: ListDirectGroupMembersProxyRequest,
    ) -> ::community_databricks_core::Result<Vec<DirectGroupMember>> {
    ...
    ) -> ::community_databricks_core::Result<ListServicePrincipalsResponse> {
        let path = String::from("/api/2.0/identity/service-principals");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("filter", &request.filter)?);
        call = call.query(query::field("page_size", &request.page_size)?);
    ...
    ) -> ::community_databricks_core::Result<ListTransitiveParentGroupsResponse> {
        let path = format!(
    ...
    ) -> ::community_databricks_core::Result<ListWorkspaceAssignmentDetailsResponse> {
        let path = String::from("/api/2.0/identity/workspace-assignment-details");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("page_size", &request.page_size)?);
        call = call.query(query::field("page_token", &request.page_token)?);
    ...
    pub async fn list_workspace_assignment_details_proxy_all(
        &self,
        request: ListWorkspaceAssignmentDetailsProxyRequest,
    ) -> ::community_databricks_core::Result<Vec<WorkspaceAssignmentDetail>> {
    ...
    ) -> ::community_databricks_core::Result<ListWorkspaceAssignmentsResponse> {
        let path = String::from("/api/2.0/identity/workspace-assignments");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("page_size", &request.page_size)?);
        call = call.query(query::field("page_token", &request.page_token)?);
    ...
    pub async fn list_workspace_assignments_proxy_all(
        &self,
        request: ListWorkspaceAssignmentsProxyRequest,
    ) -> ::community_databricks_core::Result<Vec<WorkspaceAssignment>> {
    ...
    ) -> ::community_databricks_core::Result<ResolveGroupResponse> {
    ...
    ) -> ::community_databricks_core::Result<ResolveServicePrincipalResponse> {
    ...
    ) -> ::community_databricks_core::Result<ResolveUserResponse> {
