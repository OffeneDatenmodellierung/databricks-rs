...
//! (`databricks_sdk::service::serving`).
...
impl ServingEndpointsApi {
    ...
    ) -> ::databricks_core::Result<BuildLogsResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<WaitGetServingEndpointNotUpdating<ServingEndpointDetailed>> {
    ...
    ) -> ::databricks_core::Result<ServingEndpointDetailed> {
        let path = format!(
            "/api/2.0/serving-endpoints/{}",
            path_param(&request.name.to_string(), false)
        );
    ...
    ) -> ::databricks_core::Result<GetServingEndpointPermissionLevelsResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ServingEndpointPermissions> {
        let path = format!(
    ...
    pub async fn list_page(&self) -> ::databricks_core::Result<ListEndpointsResponse> {
        let path = String::from("/api/2.0/serving-endpoints");
        let call = Call::new(Method::GET, path).workspace();
    ...
    pub async fn list_all(&self) -> ::databricks_core::Result<Vec<ServingEndpoint>> {
    ...
    pub async fn logs(
        &self,
        request: LogsRequest,
    ) -> ::databricks_core::Result<ServerLogsResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<EndpointTags> {
        let path = format!(
    ...
    pub async fn put(&self, request: PutRequest) -> ::databricks_core::Result<PutResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<PutAiGatewayResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<QueryEndpointResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<UpdateInferenceEndpointNotificationsResponse> {
        let path = format!(
...
impl<R> WaitGetServingEndpointNotUpdating<R> {
    ...
    pub async fn wait(self) -> ::databricks_core::Result<ServingEndpointDetailed> {
        self.api
