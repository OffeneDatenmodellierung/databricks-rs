...
//! (`databricks_sdk::service::pipelines`).
...
pub struct PipelineCluster {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub aws_attributes: Option<::databricks_sdk_compute::AwsAttributes>,
    /// Attributes related to clusters running on Microsoft Azure. If not
    /// specified at cluster creation, a set of default values will be used.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub azure_attributes: Option<::databricks_sdk_compute::AzureAttributes>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cluster_log_conf: Option<::databricks_sdk_compute::ClusterLogConf>,
    ...
    /// specified at cluster creation, a set of default values will be used.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub gcp_attributes: Option<::databricks_sdk_compute::GcpAttributes>,
    /// The configuration for storing init scripts. Any number of destinations
    /// can be specified. The scripts are executed sequentially in the order
    /// provided. If `cluster_log_conf` is specified, init script logs are sent
    /// to `<destination>/<cluster-ID>/init_scripts`.
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub init_scripts: Vec<::databricks_sdk_compute::InitScriptInfo>,
...
impl PipelineCluster {
    ...
    pub fn with_aws_attributes(
        mut self,
        value: impl Into<::databricks_sdk_compute::AwsAttributes>,
    ) -> Self {
    ...
    pub fn with_azure_attributes(
        mut self,
        value: impl Into<::databricks_sdk_compute::AzureAttributes>,
    ) -> Self {
    ...
    pub fn with_cluster_log_conf(
        mut self,
        value: impl Into<::databricks_sdk_compute::ClusterLogConf>,
    ) -> Self {
    ...
    pub fn with_gcp_attributes(
        mut self,
        value: impl Into<::databricks_sdk_compute::GcpAttributes>,
    ) -> Self {
    ...
    pub fn with_init_scripts(
        mut self,
        value: impl Into<Vec<::databricks_sdk_compute::InitScriptInfo>>,
    ) -> Self {
...
pub struct PipelineLibrary {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub maven: Option<::databricks_sdk_compute::MavenLibrary>,
...
impl PipelineLibrary {
    ...
    /// Set `maven`.
    #[must_use]
    pub fn with_maven(mut self, value: impl Into<::databricks_sdk_compute::MavenLibrary>) -> Self {
...
impl PipelinesApi {
    ...
    ) -> ::databricks_core::Result<ApplyEnvironmentRequestResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ClonePipelineResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<CreatePipelineResponse> {
    ...
    pub async fn delete(&self, request: DeletePipelineRequest) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/pipelines/{}",
            path_param(&request.pipeline_id.to_string(), false)
        );
    ...
    ) -> ::databricks_core::Result<GetPipelineResponse> {
        let path = format!(
            "/api/2.0/pipelines/{}",
            path_param(&request.pipeline_id.to_string(), false)
        );
    ...
    ) -> ::databricks_core::Result<GetPipelinePermissionLevelsResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<PipelinePermissions> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<GetUpdateResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ListPipelineEventsResponse> {
        let path = format!(
    ...
    pub async fn list_pipeline_events_all(
        &self,
        request: ListPipelineEventsRequest,
    ) -> ::databricks_core::Result<Vec<PipelineEvent>> {
    ...
    ) -> ::databricks_core::Result<ListPipelinesResponse> {
        let path = String::from("/api/2.0/pipelines");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("filter", &request.filter)?);
        call = call.query(query::field("max_results", &request.max_results)?);
    ...
    pub async fn list_pipelines_all(
        &self,
        request: ListPipelinesRequest,
    ) -> ::databricks_core::Result<Vec<PipelineStateInfo>> {
    ...
    ) -> ::databricks_core::Result<ListUpdatesResponse> {
        let path = format!(
            "/api/2.0/pipelines/{}/updates",
            path_param(&request.pipeline_id.to_string(), false)
        );
    ...
    pub async fn start_update(
        &self,
        request: StartUpdate,
    ) -> ::databricks_core::Result<StartUpdateResponse> {
        let path = format!(
            "/api/2.0/pipelines/{}/updates",
            path_param(&request.pipeline_id.to_string(), false)
        );
    ...
    pub async fn stop(
        &self,
        request: StopRequest,
    ) -> ::databricks_core::Result<WaitGetPipelineIdle<()>> {
        let path = format!(
    ...
    pub async fn update(&self, request: EditPipeline) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/pipelines/{}",
            path_param(&request.pipeline_id.to_string(), false)
        );
...
impl<R> WaitGetPipelineIdle<R> {
    ...
    pub async fn wait(self) -> ::databricks_core::Result<GetPipelineResponse> {
        self.api
