...
impl ServicePrincipalSecretsProxyApi {
    ...
    ) -> ::databricks_core::Result<CreateServicePrincipalSecretResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ListServicePrincipalSecretsResponse> {
        let path = format!(
            "/api/2.0/accounts/servicePrincipals/{}/credentials/secrets",
            path_param(&request.service_principal_id.to_string(), false)
        );
    ...
    pub async fn list_all(
        &self,
        request: ListServicePrincipalSecretsRequest,
    ) -> ::databricks_core::Result<Vec<SecretInfo>> {
...
impl CustomAppIntegrationApi {
    ...
    ) -> ::databricks_core::Result<CreateCustomAppIntegrationOutput> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<GetCustomAppIntegrationOutput> {
        let path = format!(
            "/api/2.0/accounts/{}/oauth2/custom-app-integrations/{}",
            path_param(self.api.account_id()?, false),
            path_param(&request.integration_id.to_string(), false)
    ...
    ) -> ::databricks_core::Result<GetCustomAppIntegrationsOutput> {
        let path = format!(
            "/api/2.0/accounts/{}/oauth2/custom-app-integrations",
            path_param(self.api.account_id()?, false)
        );
    ...
    pub async fn list_all(
        &self,
        request: ListCustomAppIntegrationsRequest,
    ) -> ::databricks_core::Result<Vec<GetCustomAppIntegrationOutput>> {
        paging::collect(self.list(request)).await
    }
...
impl OAuthPublishedAppsApi {
    ...
    ) -> ::databricks_core::Result<GetPublishedAppsOutput> {
        let path = format!(
    ...
    pub async fn list_all(
        &self,
        request: ListOAuthPublishedAppsRequest,
    ) -> ::databricks_core::Result<Vec<PublishedAppOutput>> {
        paging::collect(self.list(request)).await
    }
}
...
impl PublishedAppIntegrationApi {
    ...
    ) -> ::databricks_core::Result<CreatePublishedAppIntegrationOutput> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<GetPublishedAppIntegrationOutput> {
        let path = format!(
            "/api/2.0/accounts/{}/oauth2/published-app-integrations/{}",
            path_param(self.api.account_id()?, false),
            path_param(&request.integration_id.to_string(), false)
    ...
    ) -> ::databricks_core::Result<GetPublishedAppIntegrationsOutput> {
        let path = format!(
            "/api/2.0/accounts/{}/oauth2/published-app-integrations",
            path_param(self.api.account_id()?, false)
        );
    ...
    pub async fn list_all(
        &self,
        request: ListPublishedAppIntegrationsRequest,
    ) -> ::databricks_core::Result<Vec<GetPublishedAppIntegrationOutput>> {
        paging::collect(self.list(request)).await
    }
