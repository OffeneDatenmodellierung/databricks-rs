...
impl AlertsApi {
    ...
    pub async fn create(&self, request: CreateAlertRequest) -> ::databricks_core::Result<Alert> {
    ...
    pub async fn delete(&self, request: TrashAlertRequest) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/sql/alerts/{}",
    ...
    pub async fn get(&self, request: GetAlertRequest) -> ::databricks_core::Result<Alert> {
        let path = format!(
            "/api/2.0/sql/alerts/{}",
            path_param(&request.id.to_string(), false)
        );
    ...
    ) -> ::databricks_core::Result<ListAlertsResponse> {
        let path = String::from("/api/2.0/sql/alerts");
    ...
    pub async fn list_all(
        &self,
        request: ListAlertsRequest,
    ) -> ::databricks_core::Result<Vec<ListAlertsResponseAlert>> {
    ...
    pub async fn update(&self, request: UpdateAlertRequest) -> ::databricks_core::Result<Alert> {
        let path = format!(
            "/api/2.0/sql/alerts/{}",
            path_param(&request.id.to_string(), false)
        );
...
impl AlertsLegacyApi {
    ...
    pub async fn create(&self, request: CreateAlert) -> ::databricks_core::Result<LegacyAlert> {
    ...
    ) -> ::databricks_core::Result<LegacyAlert> {
        let path = format!(
            "/api/2.0/preview/sql/alerts/{}",
            path_param(&request.alert_id.to_string(), false)
        );
    ...
    pub async fn list(&self) -> ::databricks_core::Result<Vec<LegacyAlert>> {
        let path = String::from("/api/2.0/preview/sql/alerts");
        let call = Call::new(Method::GET, path).workspace();
    ...
    pub async fn update(&self, request: EditAlert) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/preview/sql/alerts/{}",
            path_param(&request.alert_id.to_string(), false)
        );
...
impl AlertsV2Api {
    ...
    ) -> ::databricks_core::Result<AlertV2> {
    ...
    ) -> ::databricks_core::Result<ListAlertsV2Response> {
        let path = String::from("/api/2.0/alerts");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("page_size", &request.page_size)?);
        call = call.query(query::field("page_token", &request.page_token)?);
    ...
    pub async fn list_alerts_all(
        &self,
        request: ListAlertsV2Request,
    ) -> ::databricks_core::Result<Vec<AlertV2>> {
    ...
    pub async fn trash_alert(&self, request: TrashAlertV2Request) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/alerts/{}",
            path_param(&request.id.to_string(), false)
        );
...
impl DashboardWidgetsApi {
    ...
    pub async fn create(&self, request: CreateWidget) -> ::databricks_core::Result<Widget> {
    ...
    pub async fn update(&self, request: UpdateWidgetRequest) -> ::databricks_core::Result<Widget> {
        let path = format!(
            "/api/2.0/preview/sql/widgets/{}",
            path_param(&request.id.to_string(), false)
        );
...
impl DashboardsApi {
    ...
    pub async fn delete(&self, request: DeleteDashboardRequest) -> ::databricks_core::Result<()> {
        let path = format!(
    ...
    pub async fn get(&self, request: GetDashboardRequest) -> ::databricks_core::Result<Dashboard> {
        let path = format!(
            "/api/2.0/preview/sql/dashboards/{}",
            path_param(&request.dashboard_id.to_string(), false)
        );
    ...
    pub async fn list_all(
        &self,
        request: ListDashboardsRequest,
    ) -> ::databricks_core::Result<Vec<Dashboard>> {
        paging::collect(self.list(request)).await
    }
    ...
    pub async fn restore(&self, request: RestoreDashboardRequest) -> ::databricks_core::Result<()> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<Dashboard> {
        let path = format!(
            "/api/2.0/preview/sql/dashboards/{}",
            path_param(&request.dashboard_id.to_string(), false)
        );
...
impl DataSourcesApi {
    ...
    pub async fn list(&self) -> ::databricks_core::Result<Vec<DataSource>> {
...
impl DbsqlPermissionsApi {
    ...
    ) -> ::databricks_core::Result<GetResponse> {
        let path = format!(
    ...
    pub async fn set(&self, request: SetRequest) -> ::databricks_core::Result<SetResponse> {
        let path = format!(
            "/api/2.0/preview/sql/permissions/{}/{}",
            path_param(&request.object_type.to_string(), false),
            path_param(&request.object_id.to_string(), false)
...
impl QueriesApi {
    ...
    pub async fn create(&self, request: CreateQueryRequest) -> ::databricks_core::Result<Query> {
    ...
    pub async fn delete(&self, request: TrashQueryRequest) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/sql/queries/{}",
            path_param(&request.id.to_string(), false)
        );
    ...
    pub async fn get(&self, request: GetQueryRequest) -> ::databricks_core::Result<Query> {
        let path = format!(
            "/api/2.0/sql/queries/{}",
            path_param(&request.id.to_string(), false)
        );
    ...
    ) -> ::databricks_core::Result<ListQueryObjectsResponse> {
        let path = String::from("/api/2.0/sql/queries");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("page_size", &request.page_size)?);
        call = call.query(query::field("page_token", &request.page_token)?);
    ...
    pub async fn list_all(
        &self,
        request: ListQueriesRequest,
    ) -> ::databricks_core::Result<Vec<ListQueryObjectsResponseQuery>> {
        paging::collect(self.list(request)).await
    }
    ...
    ) -> ::databricks_core::Result<ListVisualizationsForQueryResponse> {
        let path = format!(
    ...
    pub async fn list_visualizations_all(
        &self,
        request: ListVisualizationsForQueryRequest,
    ) -> ::databricks_core::Result<Vec<Visualization>> {
    ...
    pub async fn update(&self, request: UpdateQueryRequest) -> ::databricks_core::Result<Query> {
        let path = format!(
            "/api/2.0/sql/queries/{}",
            path_param(&request.id.to_string(), false)
        );
...
impl QueriesLegacyApi {
    ...
    ) -> ::databricks_core::Result<LegacyQuery> {
    ...
    ) -> ::databricks_core::Result<QueryList> {
        let path = String::from("/api/2.0/preview/sql/queries");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("order", &request.order)?);
        call = call.query(query::field("page", &request.page)?);
    ...
    pub async fn list_all(
        &self,
        request: ListQueriesLegacyRequest,
    ) -> ::databricks_core::Result<Vec<LegacyQuery>> {
        paging::collect(self.list(request)).await
    }
...
impl QueryHistoryApi {
    ...
    ) -> ::databricks_core::Result<ListQueriesResponse> {
...
impl QueryVisualizationsApi {
    ...
    ) -> ::databricks_core::Result<Visualization> {
...
impl QueryVisualizationsLegacyApi {
    ...
    ) -> ::databricks_core::Result<LegacyVisualization> {
...
impl RedashConfigApi {
    ...
    pub async fn get_config(&self) -> ::databricks_core::Result<ClientConfig> {
...
impl StatementExecutionApi {
    ...
    ) -> ::databricks_core::Result<StatementResponse> {
    ...
    ) -> ::databricks_core::Result<ResultData> {
        let path = format!(
...
impl WarehousesApi {
    ...
    ) -> ::databricks_core::Result<WaitGetWarehouseRunning<CreateWarehouseResponse>> {
    ...
    pub async fn delete(&self, request: DeleteWarehouseRequest) -> ::databricks_core::Result<()> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<WaitGetWarehouseRunning<()>> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<GetWarehouseResponse> {
        let path = format!(
            "/api/2.0/sql/warehouses/{}",
            path_param(&request.id.to_string(), false)
        );
    ...
    ) -> ::databricks_core::Result<GetWarehousePermissionLevelsResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<WarehousePermissions> {
        let path = format!(
    ...
    pub async fn get_workspace_warehouse_config(
        &self,
    ) -> ::databricks_core::Result<GetWorkspaceWarehouseConfigResponse> {
    ...
    ) -> ::databricks_core::Result<ListWarehousesResponse> {
        let path = String::from("/api/2.0/sql/warehouses");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("page_size", &request.page_size)?);
        call = call.query(query::field("page_token", &request.page_token)?);
    ...
    pub async fn list_all(
        &self,
        request: ListWarehousesRequest,
    ) -> ::databricks_core::Result<Vec<EndpointInfo>> {
        paging::collect(self.list(request)).await
    }
    ...
    ) -> ::databricks_core::Result<ListDefaultWarehouseOverridesResponse> {
        let path = String::from("/api/warehouses/v1/default-warehouse-overrides");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("page_size", &request.page_size)?);
        call = call.query(query::field("page_token", &request.page_token)?);
    ...
    pub async fn list_default_warehouse_overrides_all(
        &self,
        request: ListDefaultWarehouseOverridesRequest,
    ) -> ::databricks_core::Result<Vec<DefaultWarehouseOverride>> {
    ...
    pub async fn stop(
        &self,
        request: StopRequest,
    ) -> ::databricks_core::Result<WaitGetWarehouseStopped<()>> {
        let path = format!(
...
impl<R> WaitGetWarehouseRunning<R> {
    ...
    pub async fn wait(self) -> ::databricks_core::Result<GetWarehouseResponse> {
        self.api
