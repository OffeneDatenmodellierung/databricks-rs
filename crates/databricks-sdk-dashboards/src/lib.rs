...
//! (`databricks_sdk::service::dashboards`).
...
pub struct GenieEvalResponse {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql_execution_result: Option<::databricks_sdk_sql::StatementResponse>,
}
...
impl GenieEvalResponse {
    ...
    pub fn with_sql_execution_result(
        mut self,
        value: impl Into<::databricks_sdk_sql::StatementResponse>,
    ) -> Self {
...
pub struct GenieGetDownloadFullQueryResultResponse {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub statement_response: Option<::databricks_sdk_sql::StatementResponse>,
}
...
impl GenieApi {
    ...
    ) -> ::databricks_core::Result<WaitGetMessageGenieCompleted<GenieMessage>> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<GenieMessageComment> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<GenieSpace> {
    ...
    ) -> ::databricks_core::Result<GenieGetMessageQueryResultResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<GenieGenerateDownloadFullQueryResultResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<GenieMessage> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<GenieEvalRunResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<GenieEvalResultDetails> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<GenieListEvalResultsResponse> {
        let path = format!(
            "/api/2.0/genie/spaces/{}/eval-runs/{}/results",
            path_param(&request.space_id.to_string(), false),
            path_param(&request.eval_run_id.to_string(), false)
    ...
    ) -> ::databricks_core::Result<GenieListEvalRunsResponse> {
        let path = format!(
            "/api/2.0/genie/spaces/{}/eval-runs",
            path_param(&request.space_id.to_string(), false)
        );
    ...
    ) -> ::databricks_core::Result<GenieGetDownloadFullQueryResultResponse> {
        let path = format!(
            "/api/2.0/genie/spaces/{}/conversations/{}/messages/{}/attachments/{}/downloads/{}",
            path_param(&request.space_id.to_string(), false),
            path_param(&request.conversation_id.to_string(), false),
    ...
    ) -> ::databricks_core::Result<GenieListConversationCommentsResponse> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<GenieListConversationMessagesResponse> {
        let path = format!(
            "/api/2.0/genie/spaces/{}/conversations/{}/messages",
            path_param(&request.space_id.to_string(), false),
            path_param(&request.conversation_id.to_string(), false)
    ...
    ) -> ::databricks_core::Result<GenieListConversationsResponse> {
        let path = format!(
            "/api/2.0/genie/spaces/{}/conversations",
            path_param(&request.space_id.to_string(), false)
        );
    ...
    ) -> ::databricks_core::Result<GenieListMessageCommentsResponse> {
        let path = format!(
            "/api/2.0/genie/spaces/{}/conversations/{}/messages/{}/comments",
            path_param(&request.space_id.to_string(), false),
            path_param(&request.conversation_id.to_string(), false),
    ...
    ) -> ::databricks_core::Result<GenieListSpacesResponse> {
        let path = String::from("/api/2.0/genie/spaces");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("page_size", &request.page_size)?);
        call = call.query(query::field("page_token", &request.page_token)?);
    ...
    ) -> ::databricks_core::Result<WaitGetMessageGenieCompleted<GenieStartConversationResponse>>
    {
        let path = format!(
...
impl<R> WaitGetMessageGenieCompleted<R> {
    ...
    pub async fn wait(self) -> ::databricks_core::Result<GenieMessage> {
        self.api
...
impl LakeviewApi {
    ...
    ) -> ::databricks_core::Result<Schedule> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<Subscription> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<PublishedDashboard> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<ListDashboardsResponse> {
        let path = String::from("/api/2.0/lakeview/dashboards");
        let mut call = Call::new(Method::GET, path).workspace();
        call = call.query(query::field("page_size", &request.page_size)?);
        call = call.query(query::field("page_token", &request.page_token)?);
    ...
    ) -> ::databricks_core::Result<ListSchedulesResponse> {
        let path = format!(
            "/api/2.0/lakeview/dashboards/{}/schedules",
            path_param(&request.dashboard_id.to_string(), false)
        );
    ...
    pub async fn list_schedules_all(
        &self,
        request: ListSchedulesRequest,
    ) -> ::databricks_core::Result<Vec<Schedule>> {
    ...
    ) -> ::databricks_core::Result<ListSubscriptionsResponse> {
        let path = format!(
            "/api/2.0/lakeview/dashboards/{}/schedules/{}/subscriptions",
            path_param(&request.dashboard_id.to_string(), false),
            path_param(&request.schedule_id.to_string(), false)
    ...
    pub async fn list_subscriptions_all(
        &self,
        request: ListSubscriptionsRequest,
    ) -> ::databricks_core::Result<Vec<Subscription>> {
    ...
    ) -> ::databricks_core::Result<RevertDashboardResponse> {
        let path = format!(
    ...
    pub async fn trash(&self, request: TrashDashboardRequest) -> ::databricks_core::Result<()> {
        let path = format!(
            "/api/2.0/lakeview/dashboards/{}",
            path_param(&request.dashboard_id.to_string(), false)
        );
...
impl LakeviewEmbeddedApi {
    ...
    ) -> ::databricks_core::Result<GetPublishedDashboardTokenInfoResponse> {
        let path = format!(
