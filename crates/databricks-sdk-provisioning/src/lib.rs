...
//! (`databricks_sdk::service::provisioning`).
...
impl CredentialsApi {
    ...
    ) -> ::databricks_core::Result<Credential> {
        let path = format!(
    ...
    pub async fn list(&self) -> ::databricks_core::Result<Vec<Credential>> {
        let path = format!(
            "/api/2.0/accounts/{}/credentials",
            path_param(self.api.account_id()?, false)
        );
...
impl EncryptionKeysApi {
    ...
    ) -> ::databricks_core::Result<CustomerManagedKey> {
        let path = format!(
    ...
    pub async fn list(&self) -> ::databricks_core::Result<Vec<CustomerManagedKey>> {
        let path = format!(
            "/api/2.0/accounts/{}/customer-managed-keys",
            path_param(self.api.account_id()?, false)
        );
...
impl NetworksApi {
    ...
    ) -> ::databricks_core::Result<Network> {
        let path = format!(
    ...
    pub async fn get(&self, request: GetNetworkRequest) -> ::databricks_core::Result<Network> {
        let path = format!(
            "/api/2.0/accounts/{}/networks/{}",
            path_param(self.api.account_id()?, false),
            path_param(&request.network_id.to_string(), false)
    ...
    pub async fn list(&self) -> ::databricks_core::Result<Vec<Network>> {
        let path = format!(
            "/api/2.0/accounts/{}/networks",
            path_param(self.api.account_id()?, false)
        );
...
impl PrivateAccessApi {
    ...
    ) -> ::databricks_core::Result<PrivateAccessSettings> {
        let path = format!(
    ...
    pub async fn list(&self) -> ::databricks_core::Result<Vec<PrivateAccessSettings>> {
        let path = format!(
            "/api/2.0/accounts/{}/private-access-settings",
            path_param(self.api.account_id()?, false)
        );
...
impl StorageApi {
    ...
    ) -> ::databricks_core::Result<StorageConfiguration> {
        let path = format!(
    ...
    pub async fn list(&self) -> ::databricks_core::Result<Vec<StorageConfiguration>> {
        let path = format!(
            "/api/2.0/accounts/{}/storage-configurations",
            path_param(self.api.account_id()?, false)
        );
...
impl VpcEndpointsApi {
    ...
    ) -> ::databricks_core::Result<VpcEndpoint> {
        let path = format!(
    ...
    pub async fn list(&self) -> ::databricks_core::Result<Vec<VpcEndpoint>> {
        let path = format!(
            "/api/2.0/accounts/{}/vpc-endpoints",
            path_param(self.api.account_id()?, false)
        );
...
impl WorkspacesApi {
    ...
    ) -> ::databricks_core::Result<WaitGetWorkspaceRunning<Workspace>> {
        let path = format!(
    ...
    ) -> ::databricks_core::Result<Workspace> {
        let path = format!(
            "/api/2.0/accounts/{}/workspaces/{}",
            path_param(self.api.account_id()?, false),
    ...
    pub async fn get(&self, request: GetWorkspaceRequest) -> ::databricks_core::Result<Workspace> {
        let path = format!(
            "/api/2.0/accounts/{}/workspaces/{}",
            path_param(self.api.account_id()?, false),
            path_param(&request.workspace_id.to_string(), false)
    ...
    pub async fn list(&self) -> ::databricks_core::Result<Vec<Workspace>> {
        let path = format!(
            "/api/2.0/accounts/{}/workspaces",
            path_param(self.api.account_id()?, false)
        );
...
impl<R> WaitGetWorkspaceRunning<R> {
    ...
    pub async fn wait(self) -> ::databricks_core::Result<Workspace> {
        self.api
